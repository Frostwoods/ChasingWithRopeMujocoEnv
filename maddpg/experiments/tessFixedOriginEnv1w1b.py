...
def main():
    ...
    integrateState = FixedIntegrateState(numEntities, entitiesMovableList, massList,entityMaxSpeedList, getVelFromAgentState, getPosFromAgentState)
    ...
    if saveTraj:
        trajSavePath = os.path.join(dirName,'..','trajectory',  'LineMoveFixedBaseLine.pickle')
