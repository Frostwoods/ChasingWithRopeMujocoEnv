...
def main():
    ...
    fileName = 'runMujocoEnvWithRopesMyMADDPGchasing.py'
    # fileName = 'runMujocoEnvWithRopesMyMADDPGchasingWithoutMasterControl.py'
    numSample = None
    numCpuToUse = 18#int(0.8 * os.cpu_count())
    ...
    manipulatedVariables['damping'] = [1.0]
    manipulatedVariables['frictionloss'] = [0.2,0.4]
